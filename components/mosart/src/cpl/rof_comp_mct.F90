module rof_comp_mct
  ...
  ! rof->lnd exchange
  ! added TUnit for elevation profile
  !50==================================================
  ...
  use rof_cpl_indices  , only : rof_cpl_indices_set, nt_rtm, rtm_tracers, &
       ...
       index_r2x_Sr_channel_depth, &
       index_r2x_Sr_gage_height, &
       index_r2x_Sr_hillslope_slope, &
       index_r2x_Sr_hillslope_length, &
       index_r2x_Sr_elevation_profile1, &
       index_r2x_Sr_elevation_profile2, &
       index_r2x_Sr_elevation_profile3, &
       index_r2x_Sr_elevation_profile4, &
       index_r2x_Sr_elevation_profile5, &
       index_r2x_Sr_elevation_profile6, &
       index_r2x_Sr_elevation_profile7, &
       index_r2x_Sr_elevation_profile8, &
       index_r2x_Sr_elevation_profile9, &
       index_r2x_Sr_elevation_profile10, &
       index_r2x_Sr_elevation_profile11
...
contains
  ...
  subroutine rof_export_mct( r2x_r )
    ...
    integer  :: i,j !h2sc
    integer :: n2,  begr, endr, iu !h2sc temp variable
    logical,save :: first_time = .true.
    logical,save :: first_time_h2sc = .true. !h2sc variable
    ...
    do iu = begr, endr
       n2 = iu - begr + 1
       r2x_r%rattr(index_r2x_Sr_channel_depth, n2) =  TUnit%rdepth(iu)
       r2x_r%rattr(index_r2x_Sr_hillslope_slope, n2) =  TUnit%hslp(iu)
       r2x_r%rattr(index_r2x_Sr_hillslope_length, n2) =  TUnit%hlen(iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile1, n2) =   TUnit%e_eprof_in2( 1, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile2, n2) =   TUnit%e_eprof_in2( 2, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile3, n2) =   TUnit%e_eprof_in2( 3, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile4, n2) =   TUnit%e_eprof_in2( 4, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile5, n2) =   TUnit%e_eprof_in2( 5, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile6, n2) =   TUnit%e_eprof_in2( 6, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile7, n2) =   TUnit%e_eprof_in2( 7, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile8, n2) =   TUnit%e_eprof_in2( 8, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile9, n2) =   TUnit%e_eprof_in2( 9, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile10, n2) =   TUnit%e_eprof_in2( 10, iu)
       r2x_r%rattr(index_r2x_Sr_elevation_profile11, n2) =   TUnit%e_eprof_in2( 11, iu)
    end do
    !end if
    ...
    do iu = begr, endr
       n2 = iu - begr + 1
       r2x_r%rattr(index_r2x_Sr_gage_height, n2) =  TRunoff%yr(iu, nliq)
    enddo
