 ...
 contains
   ...
   subroutine HydrologyNoDrainage(bounds, &
     ...
     use clm_varctl           , only : use_vsfm
       !h2sc
     use SoilHydrologyMod , only : DrainageH2SC
     use clm_varctl       , only : use_h2sc
