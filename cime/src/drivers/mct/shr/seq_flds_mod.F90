...
contains
  ...
  subroutine seq_flds_set(nmlfile, ID, infodata)
    ...
    ! rof->lnd exchange
    ! First edit: 20180625
    ! Details: Add indices for gaga height
    !50==================================================
    call seq_flds_add(r2x_states,'Sr_channel_depth')
    call seq_flds_add(x2l_states,'Sr_channel_depth')
    longname = 'Channel depth from mosart'
    stdname  = 'channel_depth_from_mosart'
    units    = 'meter'
    attname  = 'Sr_channel_depth'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_gage_height')
    call seq_flds_add(x2l_states,'Sr_gage_height')
    longname = 'Gage height from stream flow'
    stdname  = 'gage_height_from_stream_flow'
    units    = 'meter'
    attname  = 'Sr_gage_height'
    call metadata_set(attname, longname, stdname, units)


    call seq_flds_add(r2x_states,'Sr_hillslope_slope')
    call seq_flds_add(x2l_states,'Sr_hillslope_slope')
    longname = 'slope of hillslope'
    stdname  = 'slope_of_hillslope'
    units    = 'degree'
    attname  = 'Sr_hillslope_slope'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_hillslope_length')
    call seq_flds_add(x2l_states,'Sr_hillslope_length')
    longname = 'length of hillslope'
    stdname  = 'length_of_hillslope'
    units    = 'meter'
    attname  = 'Sr_hillslope_length'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile1')
    call seq_flds_add(x2l_states,'Sr_elevation_profile1')
    longname = 'elevation profile1'
    stdname  = 'elevation profile1'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile1'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile2')
    call seq_flds_add(x2l_states,'Sr_elevation_profile2')
    longname = 'elevation profile2'
    stdname  = 'elevation profile2'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile2'
    call metadata_set(attname, longname, stdname, units)


    call seq_flds_add(r2x_states,'Sr_elevation_profile3')
    call seq_flds_add(x2l_states,'Sr_elevation_profile3')
    longname = 'elevation profile3'
    stdname  = 'elevation profile3'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile3'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile4')
    call seq_flds_add(x2l_states,'Sr_elevation_profile4')
    longname = 'elevation profile4'
    stdname  = 'elevation profile4'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile4'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile5')
    call seq_flds_add(x2l_states,'Sr_elevation_profile5')
    longname = 'elevation profile5'
    stdname  = 'elevation profile5'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile5'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile6')
    call seq_flds_add(x2l_states,'Sr_elevation_profile6')
    longname = 'elevation profile6'
    stdname  = 'elevation profile6'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile6'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile7')
    call seq_flds_add(x2l_states,'Sr_elevation_profile7')
    longname = 'elevation profile7'
    stdname  = 'elevation profile7'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile7'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile8')
    call seq_flds_add(x2l_states,'Sr_elevation_profile8')
    longname = 'elevation profile8'
    stdname  = 'elevation profile8'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile8'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile9')
    call seq_flds_add(x2l_states,'Sr_elevation_profile9')
    longname = 'elevation profile9'
    stdname  = 'elevation profile9'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile9'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile10')
    call seq_flds_add(x2l_states,'Sr_elevation_profile10')
    longname = 'elevation profile10'
    stdname  = 'elevation profile10'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile10'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(r2x_states,'Sr_elevation_profile11')
    call seq_flds_add(x2l_states,'Sr_elevation_profile11')
    longname = 'elevation profile11'
    stdname  = 'elevation profile11'
    units    = 'unitless'
    attname  = 'Sr_elevation_profile11'
    call metadata_set(attname, longname, stdname, units)
